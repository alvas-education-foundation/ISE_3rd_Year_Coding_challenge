...
QUESTION 2:Given an integer, and find the super digit of the integer.
...
QUESTION3:Given a time in 12 -hour AM/PM format, convert it to Railway's (24-hour) time.
Input Format
